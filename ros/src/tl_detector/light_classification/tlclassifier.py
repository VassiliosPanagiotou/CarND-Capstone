'''
Capstone Project - Vassilios Panagiotou
...
#Reusing the LeNet architecture from the TrafficSignClassifier with some small adaptations.
############################################################################################
...
#The TL-classifier doesn't really like this normalization. The results in matching rate are very bad.
#Might be that the relu activation  doesn't like color values below 128...
...
##########################################################################################################
####Training####
#Expects list of dataarrays of image elements - makes sure that all labels are given with the same numbers.
#Therefore this function randomly chooses an element e.g. yellow and appends it.
##########################################################################################################
...
#Each image is appended with
# flipped l-r-
# rotated +/-15 degree
# rotated +/-90 degree
# shifted 2,2 px to lower, right/ upper left
# This function results in 14 times more pictures than initially available.
############################################################################################################
...
##############################################################################################################
####Verification####
#Uses the LeNet architecture in combination with a given tensor-graph and verifies the matching rate
#on a dataarray of image elements. The function outputs accuracy of matching to the console.
##############################################################################################################
...
#As input it expects a dataaray of image elements.
...
#the tensor-graph and weights to the ./tensor folder.
#################################################################################################  
def trainCNN(data):
    rate = 0.0005
    epochs = 30
...
if __name__ == '__main__':
    ...
    #Folder contains  testdata  and downloaded
    #from https://github.com/udacity/iSDC-P5-traffic-light-classifier-starter-code
    #Furthermore we used TrafficLight images from the simulator
    #to train the classifier
    #img_sourcefolder = "C:/Users/vpa/Desktop/Udacity/Last/training"
    ...
    tensor_sourcepath = default_graph_path
    if train:
    ...
    if test:
        ...
        #Windows paths
        sim_green_path   = 'C:/Users/vpa/Desktop/Udacity/Last/training/sim_samples/green'
        sim_red_path     = 'C:/Users/vpa/Desktop/Udacity/Last/training/sim_samples/red'
        sim_yellow_path  = 'C:/Users/vpa/Desktop/Udacity/Last/training/sim_samples/yellow'
        real_green_path  = 'C:/Users/vpa/Desktop/Udacity/Last/training/green'
        real_red_path    = 'C:/Users/vpa/Desktop/Udacity/Last/training/red'
        real_yellow_path = 'C:/Users/vpa/Desktop/Udacity/Last/training/yellow'
        cnt = 0    
